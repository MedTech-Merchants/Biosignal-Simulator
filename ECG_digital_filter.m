...
% is called
    ...
    filtered_ecg = filter(b, 1, val); %assuming that the ecg data is stored as ecg_signal, and filtfilt applies the filter foward and backwards, minimising phase distortion which is ideal for biomedical signals that want to be preserved
