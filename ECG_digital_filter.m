...
signal_length = size(ecg_data, 2); %will give the number of columns/length of the ecd data matrix
ecg_signal = zeros(12, signal_length); %initialising empty matrix of size 12 x variable signal length
...
xlabel('Time/ s');
ylabel('Voltage/ V');
>>>>>>> dca0968c1fa56f981ca61b168cc51e3949e89d4d
