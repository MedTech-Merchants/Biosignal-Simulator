...
isBandwidthSet = false;
    ...
    CardiacConditions = { ...
        'Healthy','Atrial Fibrillation', 'Ventricular Fibrillation', 'Sinus Bradycardia', ...
    ...
    MotorConditions = {'Healthy', 'ALS', 'Myasthenia Gravis'};
    NeuralConditions = {'Healthy', 'Epilepsy', 'Parkinsons'};
